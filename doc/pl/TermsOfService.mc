...
Oświadczenie o ochronie prywatności, maj 2018.

Poniższe informacje dotyczą głównie rejestrujących konta na tym portalu internetowym.
Możesz korzystać z tej strony bez rejestracji konta.

Jak będą wykorzystywane Twoje informacje
========================================

Informacje, które podajesz na tym Portalu, mogą być przechowywane i wykorzystywane
w tylko zakresie niezbędnym do świadczenia Ci usług.

Do identyfikacji posiadacza konta wymagany jest adres e-mail. Nie będzie on udostępniany
żadnej innej witrynie ani usłudze. Służy do wysyłania powiadomień o Twoim koncie
i wykonywania zadań administracyjnych, takich jak resetowanie hasła. Możesz zrezygnować
ze wszystkich powiadomień e-mail w swoich ustawieniach.

Kanały komunikacji utworzone na tej stronie wymagają podania nazwy i zdjęcia lub awatara.
Jeśli go nie podasz, zostanie wybrany awatar domyślny. Nazwa, awatar i link do strony
internetowej kanału zostaną udostępnione innym serwerom i usługom w celu odwoływania się
do tej tożsamości. Twoja nazwa nie musi być Twoim prawdziwym imieniem nazwiskiem, a zdjęcie
lub awatar nie muszą Ciebie przypominać.

Wszystkie inne informacje, które podajesz na tym portalu są dobrowolne. 

Korzystając na tym Portalu z usług komunikacji społecznościowej i przechowywania danych
na dysku sieciowym, używasz ten portal do udostępniania informacji innym. Oferujemy
szereg opcji prywatności, które pozwalają ograniczyć udostępnianie informacji tylko do
wybranych przez Ciebie osób. 
